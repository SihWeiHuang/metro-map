...
const STRINGS = {
  "zh-Hant": {
    ...
    "app.importModeMessage": "匯入檔案中的路線 ID 與現有路線重複，請選擇匯入方式：",
    "app.importDuplicateHint": "重複的路線 ID：{ids}",
    "app.importMergeDirect": "直接加入",
    "app.importMergeDirectHint": "保留現有路線；重複的路線 ID 會自動改為新 ID",
    "app.importReplaceMatching": "取代重複",
    "app.importReplaceMatchingHint": "以檔案覆蓋相同路線 ID 的資料，其餘路線保留",
    "app.importCancel": "關閉",
    ...
    "modeHint.editStationStation": "車站編輯：可拖曳車站、點子路線新增車站、點車站開啟編輯視窗。",
  ...
  en: {
    ...
    "app.importModeMessage": "Line IDs in the file match existing lines. Choose how to import:",
    "app.importDuplicateHint": "Duplicate line IDs: {ids}",
    "app.importMergeDirect": "Add directly",
    "app.importMergeDirectHint": "Keep existing lines; duplicate line IDs get new IDs",
    "app.importReplaceMatching": "Replace duplicates",
    "app.importReplaceMatchingHint": "Overwrite lines with the same line ID; keep all others",
    ...
    "modeHint.editStationStation":
      "Edit stations: drag stations, click a sub-route to add a station, click a station for the editor.",
