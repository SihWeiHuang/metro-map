...
const STRINGS = {
  "zh-Hant": {
    ...
    "app.saveMap": "存檔",
    "app.loadMap": "載入",
    "app.saveMapTitle": "下載路線資料檔（JSON），可分享給他人載入",
    "app.loadMapTitle": "從 JSON 檔案載入路線與車站",
    "app.importReplacePrompt":
      "目前已有路線資料。\n\n按「確定」：以檔案內容取代現有使用者路線\n按「取消」：合併匯入（保留現有路線）",
    "app.importSuccess": "已載入 {routes} 條路線、{stations} 個車站。",
    "app.importErrorInvalid": "無法讀取檔案，請確認為本專案匯出的 JSON。",
    "app.importErrorUnsupported": "不支援的檔案格式。",
    "app.importErrorMissing": "檔案缺少路線或車站資料。",
    "app.importErrorGeneric": "載入失敗，請稍後再試。",
  ...
  en: {
    ...
    "app.saveMap": "Save",
    "app.loadMap": "Load",
    "app.saveMapTitle": "Download route data (JSON) to share with others",
    "app.loadMapTitle": "Load routes and stations from a JSON file",
    "app.importReplacePrompt":
      "You already have route data.\n\nOK: Replace your user routes with the file\nCancel: Merge import (keep existing routes)",
    "app.importSuccess": "Loaded {routes} route(s) and {stations} station(s).",
