...
const STRINGS = {
  "zh-Hant": {
    ...
    "app.deleteRouteOnMap": "刪除路線",
    "app.deleteRouteOnMapTitle": "刪除目前編輯中的整條路線，此動作無法復原。",
    "app.endEditRoute": "結束",
    ...
    "app.resetToDefaultTitle": "清除所有使用者路線、還原預設路線、清除本站暫存，並將地圖移回預設位置",
    "app.resetToDefaultConfirm":
      "確定要回到預設嗎？將清除所有使用者路線、介面偏好與本站暫存設定，並還原官方預設路線；頁面將重新載入，此動作無法復原。",
    ...
    "app.importSuccessReplaceMatching":
      "已取代 {replacedRoutes} 條路線、新增 {addedRoutes} 條路線，共 {stations} 個車站。",
    ...
    "tutorial.kicker": "操作說明",
    "tutorial.chapterNavAria": "章節進度",
    "tutorial.goToChapter": "前往 {title}",
    "tutorial.skip": "略過",
    "tutorial.next": "下一頁",
    "tutorial.prev": "上一頁",
    "tutorial.start": "開始使用",
    "tutorial.pageProgress": "第 {current} / {total} 頁",
    ...
    "tutorial.page3.intro": "可選取既有路線進行編輯，並使用合併路線、解散路線調整路線結構。",
    "tutorial.page4.title": "四、管理路線",
    "tutorial.page4.intro": "在路線清單中可刪除路線，以及更改路線顏色與名稱。",
    "tutorial.video.addNode": "新增節點",
    "tutorial.video.dragNode": "拖曳節點",
    "tutorial.video.deleteNode": "刪除節點",
    "tutorial.video.addNodeOnDraftRoute": "在編輯中的路線上新增節點",
    "tutorial.video.addStation": "新增車站",
    "tutorial.video.dragStation": "拖曳移動車站",
    "tutorial.video.editTransfer": "編輯轉乘站",
    "tutorial.video.moveStationLabel": "移動車站名稱",
    "tutorial.video.editExistingRoute": "編輯既有路線",
    "tutorial.video.mergeRoutes": "合併路線",
    "tutorial.video.splitRoute": "解散路線",
    "tutorial.video.deleteRoute": "刪除路線",
    "tutorial.video.changeRouteColor": "更改路線顏色",
    "tutorial.video.changeRouteName": "更改路線名稱",
    ...
    "routeList.confirmDeleteLine": "確定要刪除整條路線「{name}」嗎？此動作無法復原。",
    ...
    "routeStatus.errorCountryRequired": "請先選擇地區。",
    "routeStatus.errorCustomCountryRequired": "請輸入自訂地區名稱。",
    "routeStatus.errorCustomCityRequired": "請輸入自訂城市名稱。",
    "routeStatus.errorCityRequired": "請選擇城市。",
    "routeStatus.errorTwOtherCity": "台灣底下請選擇有效城市，不能使用「其他城市」。",
    "routeStatus.confirmDismissNewRoute": "路線已建立但尚未設定資訊。確定要關閉此視窗嗎？",
    ...
    "routeModel.mergeAlreadySame": "這兩條路線已經合併，無需再次合併。",
  ...
  en: {
    ...
    "app.deleteRouteOnMap": "Delete line",
    "app.deleteRouteOnMapTitle": "Delete the entire line being edited. This cannot be undone.",
    ...
    "app.resetToDefaultTitle":
      "Remove all user lines, restore default lines, clear site storage, and move the map to the default view",
    "app.resetToDefaultConfirm":
      "Reset to default? All user lines, UI preferences, and site storage will be cleared and official default lines restored. The page will reload. This cannot be undone.",
    ...
    "app.importSuccess": "Imported {routes} line(s) and {stations} station(s).",
    "app.importSuccessReplaceMatching":
      "Replaced {replacedRoutes} line(s), added {addedRoutes} line(s), {stations} station(s) total.",
    ...
    "tutorial.kicker": "How to use",
    "tutorial.chapterNavAria": "Chapter progress",
    "tutorial.goToChapter": "Go to {title}",
    "tutorial.skip": "Skip",
    "tutorial.next": "Next",
    "tutorial.prev": "Previous",
    "tutorial.start": "Get started",
    "tutorial.pageProgress": "Page {current} of {total}",
    ...
    "tutorial.page3.intro": "Select an existing line to edit, and use Merge lines or Split line to change line structure.",
    "tutorial.page4.title": "IV. Manage lines",
    "tutorial.page4.intro": "From the line list, delete lines and change line color or name.",
    "tutorial.video.addNode": "Add a node",
    "tutorial.video.dragNode": "Drag a node",
    "tutorial.video.deleteNode": "Delete a node",
    "tutorial.video.addNodeOnDraftRoute": "Add a node while editing a line",
    "tutorial.video.addStation": "Add a station",
    "tutorial.video.dragStation": "Drag a station to move it",
    "tutorial.video.editTransfer": "Edit a transfer station",
    "tutorial.video.moveStationLabel": "Move a station label",
    "tutorial.video.editExistingRoute": "Edit an existing line",
    "tutorial.video.mergeRoutes": "Merge lines",
    "tutorial.video.splitRoute": "Split a line",
    "tutorial.video.deleteRoute": "Delete a line",
    "tutorial.video.changeRouteColor": "Change line color",
    "tutorial.video.changeRouteName": "Change line name",
    ...
    "routeList.confirmDeleteLine": "Delete entire line \"{name}\"? This cannot be undone.",
    ...
    "routeStatus.dialogTitle": "Line info",
    ...
    "routeStatus.errorCountryRequired": "Please select a region first.",
    "routeStatus.errorCustomCountryRequired": "Please enter a custom region name.",
    "routeStatus.errorCustomCityRequired": "Please enter a custom city name.",
    "routeStatus.errorCityRequired": "Please select a city.",
    "routeStatus.errorTwOtherCity": "Taiwan does not support “Other cities”. Please pick a valid city.",
    "routeStatus.confirmDismissNewRoute": "The line was created but info is not set yet. Close this dialog anyway?",
    ...
    "routeModel.mergeAlreadySame": "These lines are already merged.",
