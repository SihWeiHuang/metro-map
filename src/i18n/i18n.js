...
const STRINGS = {
  "zh-Hant": {
    ...
    "app.importModeMessage": "匯入檔案中的群組 ID 與現有路線重複，請選擇匯入方式：",
    "app.importDuplicateHint": "重複的群組 ID：{ids}",
    "app.importMergeDirect": "直接加入",
    "app.importMergeDirectHint": "保留現有路線；重複的群組 ID 會自動改為新 ID",
    "app.importReplaceMatching": "取代重複",
    "app.importReplaceMatchingHint": "以檔案覆蓋相同群組 ID 的路線，其餘路線保留",
    "app.importCancel": "關閉",
    ...
    "routeList.mergePickHint": "點選兩條路線以合併（亦可於地圖上點選）",
    ...
    "modeHint.addRoute": "點擊地圖或路線可新增節點；拖曳節點可移動；完成後按「完成」，或按「取消」放棄。",
    "modeHint.editRouteSelect": "請先點選一條路線群組進入編輯；可按「取消」離開。",
    ...
    "routeModel.ungroupSingle": "無法解散單獨路線。",
    "routeModel.ungroupSuccess": "解散路線成功。",
    "routeList.ungroupPickHint": "點選要解散的路線群組（亦可於地圖上點選）",
  },
  en: {
    "lang.zh": "繁中",
    "lang.en": "English",
    ...
    "app.importModeMessage": "Group IDs in the file match existing routes. Choose how to import:",
    "app.importDuplicateHint": "Duplicate group IDs: {ids}",
    "app.importMergeDirect": "Add directly",
    "app.importMergeDirectHint": "Keep existing routes; duplicate group IDs get new IDs",
    "app.importReplaceMatching": "Replace duplicates",
    "app.importReplaceMatchingHint": "Overwrite routes with the same group ID; keep all others",
    ...
    "routeList.mergePickHint": "Click two routes to merge (or pick on the map)",
    ...
    "modeHint.addRoute": "Click the map or a route to add nodes; drag nodes to move. Press Done to save or Cancel to discard.",
    "modeHint.editRouteSelect": "Click a route group on the map to edit. Press Cancel to leave.",
    ...
    "routeModel.mergeSuccess": "Routes merged successfully.",
    "routeModel.ungroupNotFound": "Could not find the route to split.",
    "routeModel.ungroupSingle": "Cannot split a single-route group.",
    "routeModel.ungroupSuccess": "Route group split successfully.",
    "routeList.ungroupPickHint": "Click a route group to split (or pick on the map)",
  },
};
